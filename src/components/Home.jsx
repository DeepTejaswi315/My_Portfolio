        ...
        <div className="flex flex-col md:flex-row items-center md:items-start text-center md:text-left">
          ...
          <div className="md:w-1/2 mt-0 md:mt-24 space-y-4 order-2 md:order-1">
            ...
            <p className="text-sm md:text-md text-justify mt-2">
              I am a dedicated front-end web developer with expertise in HTML, CSS, JavaScript, and React. I am also proficient in programming languages like C, C++, and Python, with a solid understanding of Data Structures and Algorithms. My skills allow me to develop responsive web applications with efficiency.
            </p>
            ...
            <div className="flex flex-col md:flex-row items-center md:items-start justify-between space-y-6 md:space-y-0">
              ...
              <div className="space-y-2 md:mr-4">
                ...
                <ul className="flex justify-center md:justify-start space-x-5">
                  ...
                  <li>
                    <a href="https://github.com/DeepTejaswi315" target="_blank">
                      <FaGithub className="text-2xl cursor-pointer" />
                    </a>
                  </li>
                  <li>
                    <a
                      href="https://www.linkedin.com/in/deep-tejaswi-adireddy-00b596258/"
                      target="_blank"
                    >
                  ...
                  <li>
                    <a href="adeeptejaswi@gmail.com" target="_blank">
              ...
              <div className="space-y-2 font-bold">
                ...
                <div className="flex justify-center md:justify-start space-x-5">
                  ...
                  <FaDatabase className="text-xl md:text-3xl hover:scale-110 duration-200 rounded-full border-[3px]" />
                </div>
              </div>
            </div>
          </div>
